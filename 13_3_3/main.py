...
def listen(topic,msg):
    if topic == MQTT_Topic_remote.encode():
        ...
        vqr = str(msg.decode())
    elif topic == MQTT_Topic_distance.encode():
        ev3.screen.print(str(msg.decode()))
...
while True:
    ...
    client.check_msg()
    client.publish(MQTT_topic_remote,"A")
    client.publish(MQTT_topic_remote,"B")
    client.publish(MQTT_topic_remote,"C")
    client.publish(MQTT_topic_remote,"B")
    client.publish(MQTT_topic_remote,"D")
